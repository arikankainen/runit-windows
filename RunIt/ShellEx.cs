...
namespace RunIt
{
    ...
    public class ShellEx
    {
        ...
        private static extern int SHGetImageList(int iImageList, ref Guid riid, out Shell.IImageList ppv);
        ...
        public static System.Drawing.Bitmap GetBitmapFromFolderPath(string filepath, IconSizeEnum iconsize)
        {
        ...
        public static System.Drawing.Bitmap GetBitmapFromPath(string filepath, IconSizeEnum iconsize)
        {
        ...
        private static IntPtr getIconHandleFromFilePathWithFlags(string filepath, IconSizeEnum iconsize, ref Shell.SHFILEINFO shinfo, int fileAttributeFlag, uint flags)
        {
